...
\newcommand{\safeincludegraphics}[2][]{%
  \IfFileExists{paper_outputs/#2}{\includegraphics[#1]{paper_outputs/#2}}{%
    \fbox{\begin{minipage}[c][0.18\textheight][c]{0.92\linewidth}
      \centering Missing figure file\\[0.3em]\texttt{\detokenize{paper_outputs/#2}}
    \end{minipage}}%
  }%
}
...
\IfFileExists{paper_outputs/periodic_triangular_certificate_table.tex}{\input{paper_outputs/periodic_triangular_certificate_table.tex}}{%
\emph{(File \texttt{paper\_outputs/periodic\_triangular\_certificate\_table.tex} not found. Run
...
\IfFileExists{paper_outputs/periodic_triangular_extension_certificate_table.tex}{%
\resizebox{\linewidth}{!}{\input{paper_outputs/periodic_triangular_extension_certificate_table.tex}}}{%
\emph{(File \texttt{paper\_outputs/periodic\_triangular\_extension\_certificate\_table.tex} not found. Run
\texttt{python periodic\_triangular\_bulk\_certificate.py --write-table}.)}}
\end{table}
...
\label{tab:meshstats}
\IfFileExists{paper_outputs/mesh_stats_table.tex}{\input{paper_outputs/mesh_stats_table.tex}}{%
\emph{(File \texttt{paper\_outputs/mesh\_stats\_table.tex} not found. Run the companion code to generate it.)}}
\end{table}
...
\IfFileExists{paper_outputs/numerics_summary.tex}{\input{paper_outputs/numerics_summary.tex}}{%
\emph{(File \texttt{paper\_outputs/numerics\_summary.tex} not found. Run the companion code to generate it.)}}
\end{table}
...
\IfFileExists{paper_outputs/pl_boundary_comparison_table.tex}{\input{paper_outputs/pl_boundary_comparison_table.tex}}{%
\emph{(File \texttt{paper\_outputs/pl\_boundary\_comparison\_table.tex} not found. Run the companion code to generate it.)}}
\end{table}
...
\IfFileExists{paper_outputs/flux_spectral_flow_table.tex}{\input{paper_outputs/flux_spectral_flow_table.tex}}{%
\emph{(File \texttt{paper\_outputs/flux\_spectral\_flow\_table.tex} not found. Run the companion code to generate it.)}}
\end{table}
...
\label{tab:eigloc}
\IfFileExists{paper_outputs/eig_localization_summary.tex}{\input{paper_outputs/eig_localization_summary.tex}}{%
\emph{(File \texttt{paper\_outputs/eig\_localization\_summary.tex} not found. Run the companion code to generate it.)}}
\end{table}
...
\IfFileExists{paper_outputs/pl_collar_scaling_table.tex}{\input{paper_outputs/pl_collar_scaling_table.tex}}{%
\emph{(File \texttt{paper\_outputs/pl\_collar\_scaling\_table.tex} not found. Run the companion code to generate it.)}}
\end{table}
...
\IfFileExists{paper_outputs/copy_confinement_robustness_table.tex}{\input{paper_outputs/copy_confinement_robustness_table.tex}}{%
\emph{(File \texttt{paper\_outputs/copy\_confinement\_robustness\_table.tex} not found. Run the companion code to generate it.)}}
\end{table}
...
paper_outputs/periodic_triangular_certificate_table.tex
paper_outputs/periodic_triangular_extension_certificate_table.tex
run_companion_numerics_with_robustness.py
requirements.txt
paper_outputs/mesh_stats_table.tex
paper_outputs/numerics_summary.tex
paper_outputs/pl_boundary_comparison_table.tex
paper_outputs/pl_collar_scaling_table.tex
paper_outputs/flux_spectral_flow_table.tex
paper_outputs/eig_localization_summary.tex
paper_outputs/copy_confinement_robustness_table.tex
paper_outputs/fig_ex1_mesh.png
paper_outputs/fig_ex2_mesh.png
paper_outputs/fig_ex3_mesh.png
paper_outputs/fig_ex1_bulk_spectrum.png
paper_outputs/fig_ex2_bulk_spectrum.png
paper_outputs/fig_ex3_bulk_spectrum.png
paper_outputs/fig_ex1_jammed_spectrum.png
paper_outputs/fig_ex2_jammed_spectrum.png
paper_outputs/fig_ex3_jammed_spectrum.png
paper_outputs/fig_ex1_boundary_localization.png
paper_outputs/fig_component_localization_ex23.png
paper_outputs/fig_pl_boundary_comparison.png
paper_outputs/fig_ex1_edge_propagation.png
paper_outputs/fig_ex2_edge_propagation.png
paper_outputs/fig_ex3_edge_propagation.png
paper_outputs/fig_ex1_chirality_flip.png
paper_outputs/fig_multiboundary_component_drifts.png
paper_outputs/fig_flux_spectral_flow_ex2.png
paper_outputs/fig_resolvent_loglog.png
paper_outputs/fig_first_order_resolvent_loglog.png
paper_outputs/fig_leakage_loglog.png
paper_outputs/fig_first_order_localization_loglog.png
paper_outputs/fig_resolvent_convergence.png
paper_outputs/fig_ex1_leakage_vs_M.png
paper_outputs/fig_ex1_eig_localization_vs_M.png
paper_outputs/fig_collar_support_histogram.png
paper_outputs/fig_contour_margin_lower_bound.png
paper_outputs/fig_window_separation_thresholds.png
paper_outputs/fig_refinement_scaling.png
paper_outputs/fig_pl_collar_scaling.png
paper_outputs/fig_ex1_edge_propagation_disorder.png
paper_outputs/fig_copy_confinement_robustness.png
\end{verbatim}
